// Comprehensive bad words list for content filtering
const BAD_WORDS: Set<string> = new Set([
  ...
  "yiffy", "zoophilia",
  // Additional harmful words from original list
  "hate", "stupid", "idiot", "kill", "die", "hurt", "ugly", "dumb", "awful", "terrible"
]);

/**
 * Check if text contains any bad words
 * @param text - The text to check
 * @returns true if the text contains a bad word
 */
...
/**
 * Get the list of bad words (for testing purposes)
 */
export const getBadWordsList = (): string[] => Array.from(BAD_WORDS);
